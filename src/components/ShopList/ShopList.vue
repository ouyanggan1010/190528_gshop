<template>
	<div class="shop_container">
		<ul class="shop_list" v-if="shops.length>0">
			<router-link tag="li" class="shop_li border-1px" v-for="(shop,index) in shops" to="/shop" :key="index">
				<a>
					<div class="shop_left">
					...
					<div class="shop_right">
						<section class="shop_detail_header">
							...
							<ul class="shop_detail_ul">
								<li class="supports" v-for="(support,indexS) in shop.supports" :key="indexS" :style="{color:'#'+support.icon_color}">{{support.icon_name}}</li>
							</ul>
						</section>
		...
		<ul class="shop_list" v-else>
			<li class="shop_li border-1px" v-for="i in 6">
